...
namespace UnitTestProject
{
    ...
    public class UnitTest1
    {
        ...
        public void ReadOsuDb()
        {
            ...
            Debug.WriteLine($"Account name: {db.PlayerName} (account {(db.AccountUnlocked ? "unlocked" : "locked, unlocked at "+db.AccountUnlockDate)})");
            Debug.WriteLine("Account rank: " + db.UserRank);
